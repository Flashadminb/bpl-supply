  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        neutralbg: '#F0EBE0',
        // โทนสำหรับหน้าแอดมินและรายงาน — ฝั่งหน้างานยังใช้เหลืองเหมือนเดิม
        // เพราะเหลืองอ่านง่ายกลางแดด ส่วนแอดมินนั่งในร่มดูจอนาน สีเย็นสบายตากว่า
        accent: { 700: '#17457c', 600: '#1f5fae', 500: '#2a78d6', 100: '#D4E5F8', 50: '#EAF2FC' },
        mint:   { 700: '#0d6b49', 500: '#1baf7a', 100: '#CFEEE2', 50: '#E6F6F0' },
        grape:  { 700: '#5b32c4', 500: '#8B5CF6', 100: '#E2D8FD', 50: '#F1EBFE' },
        flame:  { 700: '#9c3d16', 500: '#eb6834', 100: '#FAD9CB', 50: '#FDEDE6' },
        dark: {
          DEFAULT: '#1A1712',
          2: '#232220',
          3: '#2C2A26',

-- =====================================================================
-- BPL SUPPLY — อัปเดต 016 ถึง 021 · รันไฟล์เดียวจบ
...
--  018  ย้ายเครื่องข้ามแผนก ให้หลายแผนกใช้ร่วมกันได้ (เจ้าของระบบเท่านั้น)
--  019  เพิ่ม/ลบ/แก้ชื่อแผนก เป็นของเจ้าของระบบคนเดียว
--  020  หน้าหลักฐาน เลือกดูเฉพาะวัสดุชิ้นที่ต้องการได้

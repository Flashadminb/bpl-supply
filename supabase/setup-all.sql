...
--  ② ตำแหน่งใหม่ "ผู้จ่ายอุปกรณ์" เห็นทุกแผนกเพื่อจ่ายของ แต่ไม่มีสิทธิ์แอดมินใด ๆ
...
comment on column profiles.can_dispatch is
  'ผู้จ่ายอุปกรณ์ — เห็นเครื่องทุกแผนก เบิกแทนและโอนเครื่องได้ แต่ไม่มีสิทธิ์แอดมิน';
...
/** จ่ายของแทนคนอื่นได้ไหม — แอดมิน เจ้าของระบบ หรือผู้จ่ายอุปกรณ์ */
...
-- ---------------------------------------------------------------------
-- ใครเห็นเครื่องไหน — เพิ่มผู้จ่ายอุปกรณ์ และแผนกที่รับโอน
-- ---------------------------------------------------------------------
drop policy if exists read_assets on assets;
create policy read_assets on assets for select to authenticated using (
  my_role() in ('supervisor', 'admin')
  -- ผู้จ่ายอุปกรณ์เห็นทุกเครื่อง เพราะหน้าที่คือรู้ว่าของว่างอยู่ที่ไหน
  or my_can_dispatch()
...
-- ---------------------------------------------------------------------
-- RPC: คืน Asset — ผู้จ่ายอุปกรณ์คืนแทนคนอื่นไม่ได้
--
